...
public class Server implements Runnable {
    ...
    protected static final int DEFAULT_PORT = 8187;

    public static final int DEFAULT_TIMEOUT = 2000;
    private static final int DEFAULT_TIMEOUT_CUSHION = 4000;

    public static final int FIRST_MOVE_TIMEOUT = 30000;
    private static final int FIRST_MOVE_TIMEOUT_CUSHION = 4000;

    protected static final String DEFAULT_BOARDCLASS = "hus.HusBoard";
